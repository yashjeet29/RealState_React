...
const Projects = () => {
  ...
  return (
    ...
    className='container mx-auto py-4 pt-1 px-6 md:px-20 lg:px-32 my-20 
    w-full overflow-hidden' id='Projects'>
        ...
        <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto'>Crafting Spaces, Building Legacies-Explore Our Profolio</p>
